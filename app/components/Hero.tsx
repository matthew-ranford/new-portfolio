  ...
  return (
    <>
      <main id="home" className="relative">
        ...
        <h2 className="text-7xl to-sm:text-[3.3rem] sm:text-7xl md:text-[5.5rem] lg:text-8xl xl:text-[9.3rem] 2xl:text-[11rem] 3xl:text-[13rem] 4xl:text-[14rem] 5xl:text-[17rem] 6xl:text-[18rem] text-right to-sm:text-left sm:text-left ps-4 sm:ps-4 lg:ps-8 pe-4 sm:pe-0 pt-12 to-sm:pt-10 sm:pt-20 md:pt-20 xl:pt-4 2xl:pt-12 3xl:pt-24 4xl:pt-24 5xl:pt-52 6xl:pt-24 font-bold dark:text-zinc-200 text-stone-900">
